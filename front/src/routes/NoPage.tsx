...
const NoPage: React.FunctionComponent = () => {
    ...
    return(
        <div className="flex items-center justify-center w-screen h-screen bg-gradient-to-b from-blue-light to-blue">
            <div className="px-40 py-20 bg-white dark:bg-primary rounded-md shadow-xl">
                <div className="flex flex-col items-center">
                    <div className="flex flex-row">
                        <h1 className="font-bold text-primary dark:text-white text-9xl">
                            4<span className="text-blue">0</span>4</h1>
                    </div>
                <h6 className="mb-2 text-2xl font-bold text-center md:text-3xl dark:text-white">
